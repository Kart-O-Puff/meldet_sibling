...
def load_similarity_reports():
    ...
    reports = {
        ...
        'Cosine': pd.read_csv(base_path / 'similarity_report_cosine.csv')
    }
...
def evaluate_approach(similarity_df):
    """Evaluate approach using all metrics including cosine similarity."""
    binary_ruling = similarity_df['Binary Ruling'].values
    
    # Calculate metrics for pitch and rhythm
    ...
    # Find optimal thresholds and F1 scores
